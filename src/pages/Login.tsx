    ...
    <div className="min-h-screen flex items-center justify-center bg-stone-50 px-4">
      <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl border border-stone-100 text-center">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-teal-600 hover:bg-teal-700 disabled:bg-teal-400 text-white py-3 px-4 rounded-xl font-medium transition-colors"
        >
          {loginInProgress ? (
          ...
          {loginInProgress ? 'Iniciando sesión...' : 'Iniciar sesión con Google'}
        </button>
      </div>
    </div>
  );
